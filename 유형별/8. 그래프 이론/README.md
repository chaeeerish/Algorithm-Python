...
### 문제 - 커리큘럼
- 문제 분석
  - N개의 강의 정보가 주어졌을 때, N개의 강의에 대하여 수강하기까지 걸리는 최소 시간을 구하자.
- 문제 해설
  - 각 강의를 수강하기까지 최소 시간은 result 리스트에 담는다.
  - 인접한 노드에 대하여 현재보다 강의 시간이 더 긴 경우를 찾는다면, 더 오랜 시간이 결리는 경우의 시간 값을 저장한다.